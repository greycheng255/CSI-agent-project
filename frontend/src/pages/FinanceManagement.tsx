...
import { DollarSign, QrCode, Receipt, CreditCard, Wallet } from 'lucide-react';
...
export default function FinanceManagement() {
  ...
  const activeTab: Tab =
    requestedTab === 'balance' || requestedTab === 'receipts' || requestedTab === 'payments'
      ? requestedTab
      : 'codes';
  ...
  return (
    <div className="mx-auto w-full max-w-[1440px] space-y-6">
      ...
      <div className="min-h-[400px]">
        {activeTab === 'balance' && <MyBalance embedded />}
