import { ArrowUpFromLine, BarChart3, Bot, CreditCard, DollarSign, Gavel, KeyRound, QrCode, Shield, Users } from 'lucide-react';
...
const baseAdminNavigation: WorkbenchNavigationItem[] = [
  ...
  { to: '/admin/withdrawals', label: '提现审核', description: '余额提现打款', Icon: ArrowUpFromLine },
